              ...
              <p id="r_end"><script src="/js/paypal-button.min.js?merchant=WJG3QCJ58UU98" data-button="buynow" data-name="Believers Bible Conf (${number} ${number > 1 ? 'tickets' : 'ticket'})" data-callback="http://bibleconferences.org/thanks/${buyer.id}" data-cancel_return="http://bibleconferences.org" data-return="http://bibleconferences.org/thanks" data-amount="${amount}" async></script></p>
              <div>
