...
<g:form name="seminar-selection-form" action="saveSeminarSelections">
    ...
    <table>
   		<tr>
   			<td><label>Seminar 1 (Wednesday 11:00 - 12:00)</label></td>
   			<td><g:select from="${seminar1List}" name="seminar1" 
   			     value="${attendee.seminar1}" noSelection="['':'Please make a selection']" />
   			</td>
   		</tr>
   		<tr>
   			<td><label>Seminar 2 (Wednesday 3:30 - 4:30)</label></td>
   			<td><g:select from="${seminar2List}" name="seminar2" 
   			     value="${attendee.seminar2}" noSelection="['':'Please make a selection']" />
   			</td>
   		</tr>
   		<tr>
   			<td><label>Seminar 3 (Thursday 11:00 - 12:00)</label></td>
   			<td><g:select from="${seminar3List}" name="seminar3" 
   			     value="${attendee.seminar3}" noSelection="['':'Please make a selection']" />
   			</td>
   		</tr>
   		<tr>
   			<td><label>Seminar 4 (Thursday 2:00 - 3:00)</label></td>
   			<td><g:select from="${seminar4List}" name="seminar4" 
