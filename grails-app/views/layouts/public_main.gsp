...
<html>
    ...
    <link href="${resource(dir: 'css', file: 'skel-noscript.css')}" rel="stylesheet">
    <link href="${resource(dir: 'css', file: 'style.css')}" rel="stylesheet">
    <link href="${resource(dir: 'css', file: 'style-desktop.css')}" rel="stylesheet">
		<!--[if lte IE 8]><asset:stylesheet src="ie/v8.css"/><![endif]-->
		<!--[if lte IE 9]><asset:stylesheet src="ie/v9.css"/><![endif]-->
	</head>
	<body>
