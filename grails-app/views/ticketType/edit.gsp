...
<html>
	...
	<body>
		<a href="#edit-ticketType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-ticketType" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:ticketTypeInstance, action:'update']" method="PUT" >
