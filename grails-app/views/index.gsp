	...
	<body class="homepage">
		...
		<div id="header">
			<div class="container">
				...
				<!-- Logo -->
				<div id="logo">
					<h1><a href="#">Rise Up Yo</a></h1>
				</div>

				<!-- Nav -->
				<nav id="nav">
					<ul>
						<li class="active"><a href="index.html">Speakers</a></li>
						<li><a href="index.html">Schedule</a></li>
						<li><a href="index.html">Register</a></li>
						<li><a href="index.html">Seminars</a></li>
						<li><a href="index.html">Children</a></li>
						<li><a href="index.html">Conference Location</a></li>
					</ul>
				</nav>
		...
		<div id="banner" class="cycle-slideshow"
         ...
         data-cycle-timeout="2000">&nbsp;
		  ...
		  <img src="${resource(dir:'images', file: 'pics03.jpg')}" />
    </div>
